...
0.9 - parse_title now handles "feat."/"ft.", en/em dashes, and "Song | Artist" titles.
...
def main():
    ...
    parser.add_argument("--no-lookup", action="store_true", help="Skip metadata lookup (no album/cover art/etc.)")
